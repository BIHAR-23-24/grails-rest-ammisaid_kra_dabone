                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.html">Ajouter un utilisateur</a>
                            <a class="nav-link" href="layout-sidenav-light.html">Liste des utilisateurs</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.html"> Créer une Consultation</a>
                            <a class="nav-link" href="layout-sidenav-light.html"> Liste des Consultations</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapsePagess" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.html">Créer un carnet</a>
                    ...
                    <div class="collapse" id="collapsePagesss" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.html">Créer une Pathologie</a>
                            <a class="nav-link" href="layout-sidenav-light.html"> Liste des Pathologies</a>
                        </nav>
                    </div>
